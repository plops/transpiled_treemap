// PGE3 GUI shell for the iter2 parallel treemap core (010/015/020).
...
public:
    ...
    {
        sAppName = "PGE3 - Treemap iter2 [" + m_target.string() + "]";
    }
    ...
    {
        if (x < n.rect.x || y < n.rect.y || x > n.rect.x + n.rect.w || y > n.rect.y + n.rect.h)
        {
            return nullptr;
        }
