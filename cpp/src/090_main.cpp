// treemap_parallel_cpp: --scan prints one line, --bench compares serial vs
// parallel scan/layout. No GUI here; the PGE3 shell lives in 030_pge_app.hpp
// and needs olcPixelGameEngine3.h (absent in this container).
#include <chrono>
#include <cstdio>
#include <iostream>
